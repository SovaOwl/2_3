...
void print_add(address& p, string new_city, string new_street, int new_house_number, int new_apartment_number, int new_index)
{
...
int main()
{
	...
	print_add(adr, new_city, new_street, new_house_number, new_apartment_number, new_index);
}
